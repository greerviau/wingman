...
# WM_AGENT_BIN_OVERRIDE (tests/lib.sh) so a test that forgets to stub its own
# agent never falls through to launching a real Claude Code session. 86400s (not a
