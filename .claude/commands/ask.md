...
1. Run `bin/crew-ask "<id>" "<question>"`. This delivers a framed question into
   the delegate's live session and prints a request id - relay the same team
   guardrail / dialog-freeze refusal as `/say` if it refuses to send.
